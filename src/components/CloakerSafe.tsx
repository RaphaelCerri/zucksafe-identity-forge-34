...
const CloakerSafe = () => {
  ...
  const generateCloakerCode = () => {
    ...
    // Generate a more complex and randomized code
    const code = `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Redirecionamento Seguro</title>
    <style>
        body { 
            margin: 0; 
            padding: 20px; 
...
<body>
    ...
    <script>
        ...
        function detectBot() {
            const botPatterns = [
                ...
                /baidu/i, /tiktok/i, /whatsapp/i, /telegram/i
            ];
        ...
        setTimeout(() => {
            ...
            } else if (isMobile() || detectScreenSize()) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-white mb-2">Cloaker Safe</h2>
        <p className="text-gray-400">Gera código HTML para redirecionamentos inteligentes</p>
      </div>
          ...
          <CardContent>
            {generatedCode ? <div>
                ...
                <div className="mt-4 text-green-400 text-sm space-y-1">
                  <p>✓ Detecta bots avançados automaticamente</p>
                  <p>✓ Diferencia mobile/desktop com alta precisão</p>
                  <p>✓ Loading visual com timing aleatório</p>
                  <p>✓ Proteção contra identificação automática</p>
                </div>
              </div> : <div className="text-center py-8">
                <Code className="w-12 h-12 text-gray-400 mx-auto mb-4" />
                <p className="text-gray-400">Configure os links e gere o código seguro</p>
              </div>}
          </CardContent>
        </Card>
      </div>
