        ...
        <Card className="bg-gray-800/50 border-gray-700">
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <Input
                type="url"
                placeholder="https://seusite.com/landing-segura"
                value={altLink}
            ...
            <div className="text-yellow-400 text-sm space-y-1 p-3 bg-yellow-400/10 rounded-lg">
              <p>⚠️ Aviso Legal:</p>
              <p className="text-xs">Este código é apenas para fins educacionais e de teste. Use com responsabilidade.</p>
            </div>
          </CardContent>
        </Card>
            ...
            {generatedCode ? (
              <div>
                <Textarea
                  value={generatedCode}
                  readOnly
                  className="bg-gray-700 border-gray-600 text-white font-mono text-xs min-h-[400px]"
                />
