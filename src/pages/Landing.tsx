...
const Landing = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900">
      ...
      <section className="px-4 overflow-hidden py-[22px] bg-[#11a57e]">
          ...
          <div className="max-w-6xl mx-auto mb-16">
            <Card className="bg-gray-800/50 border-2 border-gray-800 hover:border-orange-500 transition-all duration-300 p-4 sm:p-6 animate-fade-in shadow-xl shadow-orange-500/10 py-8 sm:py-12 md:py-[48px] px-[8px]">
              <CardContent className="p-0 space-y-4 sm:space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-2 py-[3px] px-[65px] justify-items-center">
                  <div className="flex items-center space-x-2">
