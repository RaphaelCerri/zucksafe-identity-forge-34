          ...
          <div className="max-w-6xl mx-auto mb-16">
            <Card className="bg-gray-800/50 border-2 border-gray-800 hover:border-orange-500 transition-all duration-300 p-4 sm:p-6 animate-fade-in shadow-xl shadow-orange-500/10 py-8 sm:py-12 md:py-[48px] px-[16px]">
              <CardContent className="p-0 space-y-4 sm:space-y-6">
                ...
                <Button size="lg" onClick={() => window.open('https://pay.perfectpay.com.br', '_blank')} className="class=\"inline-flex items-center justify-center bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-bold py-6 sm:py-8 text-xs sm:text-lg px-6 rounded shadow-lg transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-orange-500\"">
