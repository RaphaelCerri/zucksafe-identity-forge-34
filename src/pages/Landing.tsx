      ...
      <section id="products-section" className="py-20 px-2">
        <div className="container mx-auto text-center">
          ...
          <div className="max-w-6xl mx-auto mb-16">
            <Card className="bg-gray-800/50 border-2 border-gray-800 hover:border-orange-500 transition-all duration-300 p-4 sm:p-6 animate-fade-in shadow-xl shadow-orange-500/10 py-8 sm:py-12 md:py-[48px] px-[8px]">
              <CardContent className="p-0 space-y-4 sm:space-y-6">
                ...
                <Button size="lg" onClick={() => window.open('https://pay.perfectpay.com.br', '_blank')} className="inline-flex items-center justify-center bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-bold py-4 px-4 text-xs md:py-10 md:px-12 md:text-3xl lg:py-12 lg:px-16 lg:text-4xl rounded shadow-lg transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-orange-500">ADQUIRA O COMBO AGORA</Button>
