      ...
      <section className="relative py-32 px-4 overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10">
          <div className="flex justify-center mb-6 -mb-8 -mt-30">
            <img src="/lovable-uploads/c2e803d1-757b-4fdd-972b-bef45d34a3ab.png" alt="ZuckSafe Logo" className="h-[500px] w-auto -mb-20 -mt-40" />
          </div>
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12 mb-16 max-w-6xl mx-auto">
            ...
            <Card className="bg-gray-800/50 border-gray-700 hover:border-cyan-400 transition-all duration-300 p-6 animate-fade-in">
              <CardContent className="p-0 space-y-6">
                <div className="flex justify-center">
                  <h1 className="text-6xl font-bold" style={{ color: '#1bb88c' }}>ZuckSafe</h1>
                </div>
            ...
            <Card className="bg-gray-800/50 border-gray-700 hover:border-green-400 transition-all duration-300 p-6 animate-fade-in">
              <CardContent className="p-0 space-y-6">
                <div className="flex justify-center">
                  <h1 className="text-6xl font-bold" style={{ color: '#3b7fe4' }}>ZuckAds</h1>
                </div>
              ...
              <CardContent className="p-0 space-y-6">
                <div className="flex justify-center -mb-14 -mt-10">
                  <div className="flex items-center space-x-3">
                    <h1 className="text-4xl font-bold" style={{ color: '#1bb88c' }}>ZuckSafe</h1>
                    <span className="text-3xl font-bold text-white">+</span>
                    <h1 className="text-4xl font-bold" style={{ color: '#3b7fe4' }}>ZuckAds</h1>
                  </div>
                </div>
                ...
                <Button 
                  size="lg" 
                  className="w-full bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 hover:from-pink-600 hover:via-purple-600 hover:to-blue-600 text-white font-bold py-8 text-lg" 
                  onClick={() => window.open('https://pay.perfectpay.com.br', '_blank')}
                >
