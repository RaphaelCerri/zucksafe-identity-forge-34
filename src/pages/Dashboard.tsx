...
const Dashboard = () => {
  ...
  const modules = [
    { id: 'image', name: 'Refinador de Criativos', icon: <Image className="w-5 h-5" />, component: ImageRefiner },
    { id: 'text', name: 'Refinador de Texto', icon: <FileText className="w-5 h-5" />, component: TextRefiner },
