      ...
      <div className="flex">
        ...
        <Drawer open={drawerOpen} onOpenChange={setDrawerOpen}>
          <DrawerTrigger asChild>
            <Button 
              className="fixed left-4 top-32 z-50 bg-cyan-500 hover:bg-cyan-600 text-black" 
              size="icon"
            >
            ...
            <nav className="p-4 space-y-2">
              <button 
                ...
                className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-all ${
                  activeModule === 'home' ? 'bg-cyan-500 text-black font-medium' : 'text-gray-400 hover:bg-gray-800 hover:text-white'
                }`}
              >
              ...
              {modules.map(module => (
                <button 
                  ...
                  onClick={() => handleModuleChange(module.id)} 
                  className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-all ${
                    activeModule === module.id ? 'bg-cyan-500 text-black font-medium' : 'text-gray-400 hover:bg-gray-800 hover:text-white'
                  }`}
                >
                  {module.icon}
